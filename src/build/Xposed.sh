...
2() {
	...
	lspatch "facebook-arm64-v8a" "NexAlloy-nonroot*.apk" "gnadgnaoh" "--sigbypasslv 3"
	# Patch Messenger:
	get_apk "com.facebook.orca" "messenger-arm64-v8a" "apk" "arm64-v8a" "nodpi" "Android 9.0+"
	lspatch "messenger-arm64-v8a" "NexAlloy-nonroot*.apk" "gnadgnaoh" "--sigbypasslv 3"
}
3() {
	LSPatch_dl
	patch_dl
	...
	lspatch "instagram-arm64-v8a" "NexAlloy-nonroot*.apk" "gnadgnaoh" "--sigbypasslv 3"
	# Patch Thread:
	get_apk "com.instagram.barcelona" "threads-arm64-v8a" "bundle" "arm64-v8a" "320-480dpi" "Android 9.0+"
	lspatch "threads-arm64-v8a" "NexAlloy-nonroot*.apk" "gnadgnaoh" "--sigbypasslv 3"
}
4() {
	LSPatch_dl
	patch_dl
	...
	lspatch "zalo" "NexAlloy*.apk" "gnadgnaoh" "--sigbypasslv 3"
}
5() {
	LSPatch_dl
	patch_dl
	...
	lspatch "tiktok" "NexAlloy*.apk" "gnadgnaoh" "--sigbypasslv 3"
	# Patch Tiktok Asian:
	get_apk "com.ss.android.ugc.trill" "tiktok-asian" "apk"
	lspatch "tiktok-asian" "NexAlloy*.apk" "gnadgnaoh" "--sigbypasslv 3"
}
case "$1" in
    1)
        1
